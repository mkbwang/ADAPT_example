...
maaslin2_output <-invisible(Maaslin2(input_data=count_df, input_metadata=metadata,
                                     output = file.path(folder, 'DAA_month_12', 'maaslin2_output'),
                                     min_prevalence=0.05,
...
write.csv(combined_result, file.path(folder, 'DAA_month_12', "method_comparison_12month.csv"),
          row.names=F)
write.csv(adapt_details, file.path(folder, 'DAA_month_12', "ADAPT_12month_result.csv"),
          row.names=F)
