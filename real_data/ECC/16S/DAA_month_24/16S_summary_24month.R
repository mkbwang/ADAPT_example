...
comparison_24month[is.na(comparison_24month)] <- 0
...
library(reshape2)
comparison_24_long <- melt(comparison_24month, id.vars="Name", variable.name="Method",
...
comparison_24_long$Name <- factor(comparison_24_long$Name, 
                                  levels=rev(comparison_24month$Name))
