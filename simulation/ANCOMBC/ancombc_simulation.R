...
sample_metadata_mixed_low <- AGP_unbalanced_mixed_low$sample_metadata
phyobj_unbalanced_mixed_low <- phyloseq(otu_table(AGP_unbalanced_mixed_low$count_mat, taxa_are_rows = TRUE),
                                        sample_data(sample_metadata_mixed_low))
ancombc_unbalanced_mixed_low <- ancombc(phyobj_unbalanced_mixed_low, formula = 'X', p_adj_method='BH',
                                        group='X', struc_zero=TRUE, prv_cut=0.05)
performance_unbalanced_mixed_low <- evaluation(taxa_info_unbalanced_mixed_low,
                                               ancombc_unbalanced_mixed_low)
output_unbalanced_mixed_low <- list(performance=performance_unbalanced_mixed_low,
                                    ancombc_result=ancombc_unbalanced_mixed_low)
saveRDS(output_unbalanced_mixed_low,
        file.path(ancombc_folder, "DA_mixed", "low",
...
sample_metadata_mixed_medium <- AGP_unbalanced_mixed_medium$sample_metadata
phyobj_unbalanced_mixed_medium <- phyloseq(otu_table(AGP_unbalanced_mixed_medium$count_mat, taxa_are_rows = TRUE),
                                           sample_data(sample_metadata_mixed_medium))
ancombc_unbalanced_mixed_medium <- ancombc(phyobj_unbalanced_mixed_medium, formula = 'X', p_adj_method='BH',
                                           group='X', struc_zero=TRUE, prv_cut=0.05)
performance_unbalanced_mixed_medium <- evaluation(taxa_info_unbalanced_mixed_medium,
                                                  ancombc_unbalanced_mixed_medium)
output_unbalanced_mixed_medium <- list(performance=performance_unbalanced_mixed_medium,
                                       ancombc_result=ancombc_unbalanced_mixed_medium)
saveRDS(output_unbalanced_mixed_medium,
        file.path(ancombc_folder, "DA_mixed", "medium",
...
sample_metadata_mixed_high <- AGP_unbalanced_mixed_high$sample_metadata
phyobj_unbalanced_mixed_high <- phyloseq(otu_table(AGP_unbalanced_mixed_high$count_mat, taxa_are_rows = TRUE),
                                         sample_data(sample_metadata_mixed_high))
ancombc_unbalanced_mixed_high <- ancombc(phyobj_unbalanced_mixed_high, formula = 'X', p_adj_method='BH',
                                         group='X', struc_zero=TRUE, prv_cut=0.05)
performance_unbalanced_mixed_high <- evaluation(taxa_info_unbalanced_mixed_high,
                                                ancombc_unbalanced_mixed_high)
output_unbalanced_mixed_high <- list(performance=performance_unbalanced_mixed_high,
                                     ancombc_result=ancombc_unbalanced_mixed_high)
saveRDS(output_unbalanced_mixed_high, 
        file.path(ancombc_folder, "DA_mixed", "high", 
