...
settings_df <- expand.grid(FoldChange=c(3,4,5),
...
all_summaries_df$FDRLabel[all_summaries_df$FDR > 0.055 & all_summaries_df$FoldChange=="3"] <- 
  all_summaries_df$Method[all_summaries_df$FDR > 0.055 & all_summaries_df$FoldChange=="3"]
all_summaries_df$FDRLabel[all_summaries_df$FoldChange=="3" & all_summaries_df$Method=="ADAPT"] <- "ADAPT"

all_summaries_df$PowerLabel[all_summaries_df$FoldChange=="3"] <- 
  all_summaries_df$Method[all_summaries_df$FoldChange=="3"]
